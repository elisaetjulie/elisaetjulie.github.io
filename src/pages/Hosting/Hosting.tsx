...
import { StyledContainer, StyledList } from "./Hosting.styles";
...
const Hosting = ({ className }: HostingProps) => {
  return (
    <StyledContainer className={className}>
      Voici des possibilités de logements autour de la ferme de Perinaguen pour
      le week-end. Attention sur la période estivale les locations de
      mobil-homes et de gîtes se font le plus souvent du samedi au samedi.
      N'hésitez pas à profiter de l'occasion pour visiter le pays bigouden.
      ...
      <StyledList>
        ...
        <li>
          Chambres d’hôtes Le Trymen, 127 Rue du Port Saint-Guénolé, 29760
          Penmarc'h
        </li>
